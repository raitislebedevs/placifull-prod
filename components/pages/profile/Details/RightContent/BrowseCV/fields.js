const fields = (t) => [
  {
    key: 'workExpierience',
    type: 'selectMulti',
    label: t('profile:right-content.browser-cv.work-expierience'),
    isMulti: true,
    options: [
      {
        value: '',
  ...
  },
  {
    ...
    options: [
      ...
      {
        value: 'electronicsTelecomunication',
        label: t('job-common:work-area.options.electronics'),
        id: 'workExpectations',
      },
      {
        value: 'freelanceTemporary',
  ...
  },
  {
    key: 'educationFit',
    type: 'selectMulti',
    label: t('profile:right-content.browser-cv.education-fit'),
    isMulti: true,
    options: [
      {
        value: '',
  ...
  },
  {
    key: 'seniority',
    type: 'selectMulti',
    label: t('profile:right-content.browser-cv.seniority'),
    isMulti: true,
    options: [
      {
        value: '',

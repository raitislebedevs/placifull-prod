  ...
  return (
    <div className="left-section__general-info">
      <SectionHeading className="general-info__heading">
        {t('real-estate-detail:general-info.heading')}
      </SectionHeading>
              ...
              <Row>
                <Col lg={4} md={4} sm={6} xs={12} className="items__col">
                  <div className={'offer__price'}>
                    {t('real-estate-detail:general-info.bid-price')}
                  </div>
                </Col>
                <Col lg={5} md={5} sm={6} xs={12} className="items__col">
                  <Form.Group>
                    <NumberFormat
                      ...
                      value={bidPrice}
                      placeholder={t(
                        'real-estate-detail:general-info.bid-placeholder'
                      )}
                ...
                <Col lg={3} md={3} sm={12} xs={12} className="items__col">
                  ...
                  >
                    {isLoading ? (
                      ...
                      <>{t('real-estate-detail:general-info.submit')}</>
                    )}
                  </Button>
                </Col>
              </Row>

    ...
    <div className="contact__form">
      ...
      <Form className="contact-form__form" onSubmit={handleSubmit}>
        <div className="form__title">
          {t('job-detail:contact-form.form.heading')}
        </div>
        <Form.Group>
          <Form.Control
            id={'fullName'}
            ...
            placeholder={t('job-detail:contact-form.form.fullName')}
          />
        </Form.Group>
        <Form.Group>
          <Form.Control
            ...
            type="text"
            autoComplete="current-text"
            placeholder={t('job-detail:contact-form.form.phoneNumber')}
          />
        </Form.Group>
        <Form.Group>
          <Form.Control
            ...
            type="emailId"
            autoComplete="current-text"
            placeholder={t('job-detail:contact-form.form.email')}
          />
        </Form.Group>
        <Form.Group>
          <Form.Control
            ...
            type="message"
            placeholder={t('job-detail:contact-form.form.message')}
            autoComplete="current-text"
          />
        </Form.Group>
        <Button
        ...
        >
          {isLoading ? (
            ...
            <>{t('job-detail:contact-form.form.submit')}</>
          )}
        </Button>
      </Form>
    </div>

...
function DepositAccount(props) {
  ...
  const [isAccountsSettingsOpened, setIsAccountsSettingsOpened] = useState(
    false
  );
  ...
  const handleActiveRows = rowId => {
    if (expandedRows?.includes(rowId)) return 'active';
    return '';
  };
  useEffect(() => {
    setTimeout(async () => {
  ...
  const viewEditExpenses = id => {
    setIsExpensesOpened(!isExpensesOpened);
  };
  ...
  return (
    <>
            ...
            <div className="account__container">
              <div className="account__heading">
                ...
                <div
                  className="settings__button"
                  onClick={() =>
                    setIsAccountSettingsOpened(!isAccountSettingsOpened)
                  }
                >
                  <AiOutlineSetting />
                </div>
              ...
              <div className="table__overflow">
                <table className="table__Listing">
                  <thead className="thead-dark">
                    <tr>
                      <th colSpan="2" scope="col" className="empty__cell"></th>
                      <th colSpan="12" className="period__heading">
                        Year 2022
                      </th>
                    </tr>
                  ...
                  <tbody>
                    <tr className={'standalone__row'}>
                      <td
                        onClick={() => handleExpandedRows('food')}
                        className={'icon__button'}
                        scope="col"
                      >
                        {handleActiveRows('food') === 'active' ? (
                          <MdOutlineExpandMore />
                        ) : (
                          <MdOutlineExpandLess />
                        )}
                    ...
                    <tr
                      className={`expandable__row  ${handleActiveRows('food')}`}
                    >
                      <td scope="col"></td>
                      <td scope="col">Fruits & Vegitables</td>
                      <td
                        onClick={() => viewEditExpenses('sdgsdg-sdhsdh-hsdsdh')}
                        scope="col"
                        className="spent__amount"
                      >
                        $ {formatNumber(25.44)}
                      </td>
                      <td
                    ...
                    <tr
                      className={'standalone__row'}
                      data-toggle="collapse"
                      data-target="."
                      aria-expanded="false"
                    >
                      <td className={'icon__button'} scope="col">
                        <MdOutlineExpandMore />
                      </td>
                      <td className={'icon__button'} scope="col">
                        Home utilitis
      ...
      <ExpenseModal
        showModal={isExpensesOpened}
        handleModalClose={() => {
          setIsExpensesOpened(!isExpensesOpened);
        }}
        processSubmit={processSettings}
        headerText={'Food - Fruits & Vegitables (73.45%)'}
        submitText={'Submit'}
        cancelText={'Cancel'}
      />
      <AccountsSettingsModal
        showModal={isAccountsSettingsOpened}
        handleModalClose={() => {
          setIsAccountsSettingsOpened(!isAccountsSettingsOpened);
        }}
      ...
      <AccountSettingsModal
        showModal={isAccountSettingsOpened}
        handleModalClose={() => {
          setIsAccountSettingsOpened(!isAccountSettingsOpened);
        }}
        setSubmitCurrency={setSubmitCurrency}
